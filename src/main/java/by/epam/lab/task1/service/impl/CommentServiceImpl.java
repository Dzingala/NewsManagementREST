...
public class CommentServiceImpl implements CommentService{
    ...
    public Long create(Comment comment) throws ServiceException {
        logger.debug("Creating comment in CommentService");
        Long commentId = null;
        try{
            commentId=commentsRepository.create(comment);
        }catch (DAOException e){
            logger.error("DAOException while creating comment in CommentService");
    ...
    public ArrayList<Comment> readAllByNewsId(Long newsId) throws ServiceException {
        logger.debug("Reading all comments by news id in CommentService");
        ...
        try{
            ...
            logger.error("DAOException while reading all comments by news id in CommentService");
    ...
    public void delete(Comment comment) throws ServiceException {
        logger.debug("Deleting comment in CommentService");
        try{
            commentsRepository.delete(comment.getId());
        } catch (DAOException e) {
            logger.error("DAOException while deleting comment in CommentService");
    ...
    public void update(Comment comment) throws ServiceException {
        logger.debug("Updating comment in CommentService");
        try{
            commentsRepository.update(comment.getId(),comment);
        } catch (DAOException e) {
            logger.error("DAOException while updating comment in CommentService");
    ...
    public Comment read(Long commentId) throws ServiceException {
        ...
        try{
            ...
            logger.error("DAOException while reading comment in CommentService");
